...
const models: TsoaRoute.Models = {
  ...
  Partial_VerifyDTO_: {
    ...
    type: {
      ...
      nestedProperties: {
        proof: { ref: 'ISuccessResult' },
        signal: { dataType: 'string' },
      },
      validators: {},
    },
  },
  ...
  Condition: {
    ...
    type: {
      dataType: 'union',
      subSchemas: [
        { dataType: 'enum', enums: ['less than'] },
        { dataType: 'enum', enums: ['greater than'] },
        { dataType: 'enum', enums: ['equal to'] },
      ],
      validators: {},
    },
  },
  ...
  Partial_UserDTO_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        worldId: { dataType: 'string' },
        alarms: {
          dataType: 'array',
          array: { dataType: 'refObject', ref: 'AlarmDTO' },
        },
        createdAt: { dataType: 'datetime' },
        updatedAt: { dataType: 'datetime' },
      },
...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function VerifyController_verify(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.post(
    '/api/users/:wallet_address/alarms',
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.addOrRemoveAlarms,
    ),

    async function UserController_addOrRemoveAlarms(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.getUserWithAlarms,
    ),

    async function UserController_getUserWithAlarms(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
